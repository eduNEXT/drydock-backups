...
# drydock_backups/templates/drydock_backups/tasks/
# and then add it to the MY_INIT_TASKS list. Each task is in the format:
# ("<service>", ("<path>", "<to>", "<script>", "<template>"))
MY_INIT_TASKS: list[tuple[str, tuple[str, ...]]] = [
    # For example, to add LMS initialization steps, you could add the script template at:
    # drydock_backups/templates/drydock_backups/tasks/lms/init.sh
    # And then add the line:
    ### ("lms", ("drydock_backups", "tasks", "lms", "init.sh")),
]
...
hooks.Filters.ENV_TEMPLATE_TARGETS.add_items(
    ...
    # For example, ``drydock_backups/templates/drydock_backups/build``
    # will be rendered to ``$(tutor config printroot)/env/plugins/drydock_backups/build``.
    [
...
### @click.group()
### def drydock_backups() -> None:
###     pass


### hooks.Filters.CLI_COMMANDS.add_item(drydock_backups)


# Then, you would add subcommands directly to the Click group, for example:


### @drydock_backups.command()
...
#   $ tutor drydock_backups example-command
